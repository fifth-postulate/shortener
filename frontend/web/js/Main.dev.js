...
var $author$project$Main$FlowBroke = {$: 'FlowBroke'};
var $author$project$Main$Received = function (a) {
	return {$: 'Received', a: a};
};
var $author$project$Main$Shortening = {$: 'Shortening'};
var $author$project$Main$Success = function (a) {
	return {$: 'Success', a: a};
};
var $author$project$Main$encode = function (command) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'url',
				$elm$json$Json$Encode$string(command.url))
			]));
};
...
var $author$project$Main$Shortened = function (a) {
	return {$: 'Shortened', a: a};
};
var $author$project$Main$problemDecoder = A2($elm$json$Json$Decode$field, 'reason', $elm$json$Json$Decode$string);
var $author$project$Main$DataSheet = F2(
	function (_short, url) {
		return {_short: _short, url: url};
	});
var $author$project$Main$sheetDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$DataSheet,
...
var $author$project$Main$outcomeDecoder = A2(
	$elm$json$Json$Decode$andThen,
	$author$project$Main$decoderSwitch,
	A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string));
...
var $author$project$Main$update = F2(
	function (message, model) {
				...
				default:
					if (_v0.b.$ === 'Shortening') {
						...
						if (result.$ === 'Ok') {
							...
							return _Utils_Tuple2(
								$author$project$Main$Success(outcome),
								$elm$core$Platform$Cmd$none);
						} else {
							var reason = result.a;
							return _Utils_Tuple2(
								$author$project$Main$Failure(reason),
								$elm$core$Platform$Cmd$none);
						}
					} else {
						break _v0$3;
		...
		return _Utils_Tuple2($author$project$Main$FlowBroke, $elm$core$Platform$Cmd$none);
	});
var $author$project$Main$InputUpdated = function (a) {
	return {$: 'InputUpdated', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$placeholder('Enter an URL'),
						$elm$html$Html$Attributes$name('url'),
						$elm$html$Html$Events$onInput($author$project$Main$InputUpdated)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$Shorten)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Shorten')
					]))
			]));
};
var $author$project$Main$shorteningView = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			$elm$html$Html$text('url is being shortened')
		]));
var $author$project$Main$successView = function (sheet) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(sheet.url + ' is shortened to')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(sheet._short)
					]))
			]));
};
var $author$project$Main$whoops = function (explanation) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$view = function (model) {
	switch (model.$) {
		case 'NotAskedYet':
			var command = model.a;
			return $author$project$Main$askUrlView(command);
		case 'Shortening':
		...
		case 'Success':
			if (model.a.$ === 'Shortened') {
				var sheet = model.a.a;
				return $author$project$Main$successView(sheet);
			} else {
				var reason = model.a.a;
				return $author$project$Main$whoops(reason);
			}
		default:
			return $author$project$Main$whoops('Illegal flow state occured');
	}
};
